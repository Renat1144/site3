...
$tours      = array(
	...
	array(
		...
		'price'      => array(
			'current' => '74 600–214 000 ₽',
			'note'    => 'Цена может меняться. Чтобы уточнить актуальную стоимость, свяжитесь с нами или оставьте заявку на обратный звонок по кнопке ниже — мы обязательно с вами свяжемся!',
		),
		'card_facts' => array( '5 дней', '8–12 человек', '74 600–214 000 ₽' ),
		'cta'        => 'Оставить заявку',
	),
	array(
		'image'      => 'deti.png',
...
<?php endforeach; ?>
    ...
    <!-- wp:group {"align":"wide","className":"primary-tour-footer","layout":{"type":"default"}} --><div class="wp-block-group alignwide primary-tour-footer">
        <!-- wp:group {"className":"primary-tour-facts","layout":{"type":"grid","columnCount":5,"minimumColumnWidth":null}} --><div class="wp-block-group primary-tour-facts">
          ...
          <!-- wp:paragraph --><p><strong>8–12</strong><span>участников</span></p><!-- /wp:paragraph -->
  ...
  <div id="dates" class="wp-block-group alignfull dates-section reveal-on-scroll">
    ...
    <div class="wp-block-columns alignwide are-vertically-aligned-stretch dates-grid">
      ...
      <div class="wp-block-column is-vertically-aligned-stretch offer-card">
        ...
        <!-- wp:group {"className":"offer-price-row","layout":{"type":"flex","flexWrap":"wrap"}} --><div class="wp-block-group offer-price-row"><!-- wp:paragraph {"className":"offer-price"} --><p class="offer-price"><?php echo esc_html( $primary_tour['price']['current'] ); ?></p><!-- /wp:paragraph --></div><!-- /wp:group -->
...
<?php endforeach; ?>
  ...
  <div id="reviews" class="wp-block-group alignfull section-shell reviews-section reveal-on-scroll">
    <!-- wp:columns {"align":"wide","verticalAlignment":"bottom","className":"reviews-heading"} --><div class="wp-block-columns alignwide are-vertically-aligned-bottom reviews-heading"><!-- wp:column {"verticalAlignment":"bottom","width":"100%"} --><div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:100%"><!-- wp:paragraph {"className":"eyebrow reviews-eyebrow"} --><p class="eyebrow reviews-eyebrow">Отзывы путешественников</p><!-- /wp:paragraph --><!-- wp:heading {"fontSize":"xl"} --><h2 class="wp-block-heading has-xl-font-size">Слова, которые<br><em>хочется сохранить.</em></h2><!-- /wp:heading --></div><!-- /wp:column --></div><!-- /wp:columns -->
    <!-- wp:group {"align":"wide","className":"reviews-grid reviews-grid-real","layout":{"type":"grid","columnCount":2,"minimumColumnWidth":null}} --><div class="wp-block-group alignwide reviews-grid reviews-grid-real">
      <!-- wp:group {"className":"review-card","layout":{"type":"constrained"}} --><div class="wp-block-group review-card"><!-- wp:paragraph {"className":"review-card-label"} --><p class="review-card-label">Первое знакомство · Стамбул</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-quote"} --><p class="review-card-quote">«Хочется поблагодарить Ксению за проведённое с нами время. В Стамбуле мы были впервые. После столь познавательных экскурсий и общения с Ксенией остаются только самые положительные эмоции и много вопросов — вопросов к себе. Ксения обладает профессиональными знаниями и поразительной работоспособностью. Пунктуальна, симпатична… Рекомендую».</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-author"} --><p class="review-card-author">Алла</p><!-- /wp:paragraph --></div><!-- /wp:group -->
      <!-- wp:group {"className":"review-card review-card-featured","layout":{"type":"constrained"}} --><div class="wp-block-group review-card review-card-featured"><!-- wp:paragraph {"className":"review-card-label"} --><p class="review-card-label">Семейное путешествие</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-quote"} --><p class="review-card-quote">«Мы с дочкой очень счастливо провели наш отпуск в Стамбуле. Ксения — великолепный гид и прекрасный человек. Экскурсии очень интересные, но самым важным для меня было то, что всё время мы были окружены теплом, вниманием и заботой Ксении. Не могу не отметить её организационные и человеческие качества! И, конечно же, ничто человеческое Ксении не чуждо — именно по её рекомендациям мы посетили замечательные рестораны с настоящей стамбульской „нетуристической“ кухней, которые помогли нам ещё глубже проникнуть в образ жизни и традиции города».</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-author"} --><p class="review-card-author">Надежда</p><!-- /wp:paragraph --></div><!-- /wp:group -->
      <!-- wp:group {"className":"review-card review-card-featured","layout":{"type":"constrained"}} --><div class="wp-block-group review-card review-card-featured"><!-- wp:paragraph {"className":"review-card-label"} --><p class="review-card-label">Неделя в Стамбуле</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-quote"} --><p class="review-card-quote">«Хотим выразить огромную благодарность Ксении за чёткую организацию, тёплую встречу и прекрасную подачу информации! Мы приехали на неделю впервые и получили колоссальное удовольствие от поездки, зарядились энергией и позитивными эмоциями. Обязательно вернёмся снова! Благодаря профессионализму экскурсовода вы не только узнаете многое об истории и культурных ценностях Стамбула, но и получите ответы на тысячу и один вопрос. Ксения очень эрудированна, легка и приятна в общении, буквально предугадывает желания! У нас осталось очень хорошее впечатление от проведённых в Стамбуле дней».</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-author"} --><p class="review-card-author">Валентина</p><!-- /wp:paragraph --></div><!-- /wp:group -->
      <!-- wp:group {"className":"review-card","layout":{"type":"constrained"}} --><div class="wp-block-group review-card"><!-- wp:paragraph {"className":"review-card-label"} --><p class="review-card-label">Авторский тур · Стамбул</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-quote"} --><p class="review-card-quote">«Спасибо вам, Ксения, за запоминающийся тур и такую организацию, где всё продумано до мелочей! Мы отдохнули так, как никогда прежде. Ксения и Алина — лучшие! С первой минуты встречи создалось впечатление, что мы знакомы всю жизнь. Внимательность, хорошая подача информации, интересные рассказы и лёгкая, душевная атмосфера в группе. Яркие впечатления! Незабываемые закаты! Всю эту красоту словами не передать — я до сих пор восхищаюсь изяществом и грандиозностью улочек, строений и красивых мест. Обязательно ещё вернёмся! Стамбул просто покорил нас».</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-author"} --><p class="review-card-author">Татьяна</p><!-- /wp:paragraph --></div><!-- /wp:group -->
      <!-- wp:group {"className":"review-card","layout":{"type":"constrained"}} --><div class="wp-block-group review-card"><!-- wp:paragraph {"className":"review-card-label"} --><p class="review-card-label">После первой поездки</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-quote"} --><p class="review-card-quote">«Хочется поблагодарить Ксению за проведённое с нами время. В Стамбуле были впервые. После столь познавательных экскурсий и общения с Ксенией остаются только самые положительные эмоции и много вопросов — вопросов к себе. Ксения обладает профессиональными знаниями и поразительной работоспособностью. Пунктуальна, симпатична… Рекомендую. Ещё раз спасибо. Удачи!»</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-author"} --><p class="review-card-author">Алла</p><!-- /wp:paragraph --></div><!-- /wp:group -->
      <!-- wp:group {"className":"review-card review-card-featured","layout":{"type":"constrained"}} --><div class="wp-block-group review-card review-card-featured"><!-- wp:paragraph {"className":"review-card-label"} --><p class="review-card-label">Впечатления от недели в городе</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-quote"} --><p class="review-card-quote">«Хотим выразить огромную благодарность Ксении за чёткую организацию, тёплую встречу и прекрасную подачу информации! Мы приехали на неделю впервые и получили колоссальное удовольствие от поездки, зарядились энергией и позитивными эмоциями. Обязательно вернёмся снова! Благодаря профессионализму экскурсовода вы не только узнаете многое об истории и культурных ценностях Стамбула, но и получите ответы на тысячу и один вопрос. Ксения очень эрудированна, легка и приятна в общении, буквально предугадывает желания! У нас осталось очень хорошее впечатление от проведённых в Стамбуле дней!»</p><!-- /wp:paragraph --><!-- wp:paragraph {"className":"review-card-author"} --><p class="review-card-author">Валентина</p><!-- /wp:paragraph --></div><!-- /wp:group -->
    </div><!-- /wp:group -->
  </div>
  <!-- /wp:group -->
